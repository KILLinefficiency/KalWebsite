...
<Content title="Introduction" desc="Glad to see you here!" next="{base}/docs/install">
    ...
    <br /><br />
    With its simple and compact syntax, Kal allows you to prototype quickly.
    ...
    With a simple setup and easy to use application programming interface, Kal can enhance existing codebases in no time.

    <br /><br />
    This documentation attempts at explaining Kal in as much detail as possible.
    The reader is expected to have some prior programming experience in order to best understand and use Kal.
    ...
    Users are requested to submit bug reports in the <a href="https://github.com/KILLinefficiency/Kal/issues" target="_blank">Issues Section</a> at the <a href="https://github.com/KILLinefficiency/Kal" target="_blank">GitHub repository</a>.
</Content>